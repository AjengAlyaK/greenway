...
const BetterFuture = () => {
    return (
        <Grid
            container
            spacing={{ xs: 0, md: 2 }}
            sx={{ flexGrow: 1,pt: {xs: 6, md: 5}, pb: {xs: 3, md:5}, px: { xs: 2, md: 10 } }}
        >
            {/* Left Content */}
            <Grid
                item
            ...
            >
                <Stack spacing={2}>
                    <Typography sx={{ color: '#006E6F', typography: { xs: 'h4', sm: 'h3' }, textAlign: { xs: 'center', md: 'justify' }, fontWeight: { xs: 'bold' } }}>Eco Friendly Travel For Better Future</Typography>
